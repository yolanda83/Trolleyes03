...
public class ProductoDao {
    ...
    public ProductoBean create(ProductoBean oProductoBean) throws Exception {
        String strSQL = "INSERT INTO " + ob + " (`id`, `codigo`, `desc`, `existencias`, `foto`, `id_tipoProducto`) VALUES (NULL, ?, ?, ?, ?, ?); ";
        ResultSet oResultSet = null;
        PreparedStatement oPreparedStatement = null;
        try {
            oPreparedStatement = oConnection.prepareStatement(strSQL);
            ...
            oPreparedStatement.setString(4, oProductoBean.getFoto());
            oPreparedStatement.setInt(5, oProductoBean.getId_tipoProducto());
    ...
    public int update(ProductoBean oProductoBean) throws Exception {
        int iResult = 0;
        String strSQL = "UPDATE " + ob + " SET codigo = ?, desc = ?, existencias = ?, foto = ?, id_tipoProducto = ? WHERE id = ?;";
