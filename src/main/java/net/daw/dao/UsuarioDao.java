...
//        String strSQL = "INSERT INTO " + ob + " (`id`, `dni`, `nombre`, `ape1`, `ape2`, `login`, `pass`, `id_tipoUsuario`) VALUES (NULL, ?); ";
        ...
        sql.append("INSERT INTO " + ob).
                append(" (`id`, `dni`, `nombre`, `ape1`, `ape2`, `login`, `pass`, `id_tipoUsuario`) ").
                append("VALUES (NULL,?,?,?,?,?,?,?);");
        ResultSet oResultSet = null;
        PreparedStatement oPreparedStatement = null;
        try {
        ...
        if (iRpp > 0 && iRpp < 100000 && iPage > 0 && iPage < 100000000) {
            ...
            try {
                ...
                while (oResultSet.next()) {
                    UsuarioBean oTipousuarioBean = new UsuarioBean();
                    oTipousuarioBean.setId(oResultSet.getInt("id"));
                    oTipousuarioBean.setDni(oResultSet.getString("dni"));
                    oTipousuarioBean.setNombre(oResultSet.getString("nombre"));
                    oTipousuarioBean.setApe1(oResultSet.getString("ape1"));
                    oTipousuarioBean.setApe2(oResultSet.getString("ape2"));
                    oTipousuarioBean.setLogin(oResultSet.getString("login"));
                    oTipousuarioBean.setPass(oResultSet.getString("pass"));
                    oTipousuarioBean.setId_tipoUsuario(oResultSet.getInt("id_tipoUsuario"));
                    alUsuarioBean.add(oTipousuarioBean);
                }
            } catch (SQLException e) {
